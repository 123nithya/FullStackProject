                    ...
                    <MDBCol md='5' className='position-relative'>
                        ...
                        <MDBCard className='my-5 bg-glass' style={{ width: '90%', height: '90%' }}>
                            <MDBCardBody className='p-5'>
                                ...
                                <MDBInput wrapperClass='mb-4' value={formValue.password} onChange={onChange} required name='Password' label='Email' id='form4' type='email' />
                                <MDBInput wrapperClass='mb-4' value={formValue.confirm} onChange={onChange} required name='ConfirmPassword' label='Password' id='form4' type='password' />
                                <MDBInput wrapperClass='mb-4' name='Phone' value={formValue.phone} onChange={onChange} required label='Phone' id='form4' type='tel' pattern='[0-9]-{10}' />
